...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (type == "standard")
            {
                StandardGradeBook standardGradeBook = new StandardGradeBook(name, bool.Parse(isWeight));
                GradeBookUserInterface.CommandLoop(standardGradeBook);
            }
            else if (type == "ranked")
            {
                RankedGradeBook rankedGradeBook = new RankedGradeBook(name, bool.Parse(isWeight));
